...
<!--header-->
	...
	<section>
		...
		<div class="ac_icon">
			...
			<img alt="" src="/Html_ex2/images/apply.png">
			<img alt="" src="/Html_ex2/images/apply3.png" id="ap1">
		</div>
		
	<div class="ad_suc">
			<div><h1>Congratulation! New Account</h1></div>
			<div id="ad_suc_box1"><a href="/Html_ex2/index.jsp">Main</a></div>
			<div id="ad_suc_box2"><a href="/Html_ex2/login/login.jsp">Login</a></div>
