...
<section>
		<div class= "img">
			...
			<h1>회원가입 및 약관동의</h1><br><br>
			
			<hr><br>
				 회원으로 가입을 원하실 경우,개인정보 수집 동의에 대한 <br>
				 안내를 읽고 동의여부를 선택하여 주시기 바랍니다. <br><br>
				 				
				개인정보 수집 동의(필수)<input type="checkbox" checked="checked"><br><br>
				
				<hr><br>
				
				
				마케팅 수신에 대해서 동의를 하지 않아도 회원가입이 가능합니다. <br>
				단, 각종 이벤트 응모 및 DM발송 서비스 등 마케팅 활동에 <br>
				제한될 수 있음을 알려드립니다.<br><br>
				마케팅 수신 동의(선택)<input type="checkbox" checked="checked"><br><br>
				<hr>
				
				<h3><a href="#" id="agree">확인</a></h3>
			</div>
